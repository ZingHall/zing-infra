...
output "ecs_service_id" {
  ...
  value       = aws_ecs_service.file_server.id
}

output "ecs_service_name" {
  description = "ECS Service name"
  value       = aws_ecs_service.file_server.name
}

output "ecs_task_definition_arn" {
  description = "ECS Task Definition ARN"
  value       = aws_ecs_task_definition.file_server.arn
}
...
output "security_group_id" {
  ...
  value       = aws_security_group.ecs_file_server.id
}
